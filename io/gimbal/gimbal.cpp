...
void Gimbal::read_thread() {
  ...
  while (!quit_) {
    ...
    if (rx_data_.head[0] != 'T' || rx_data_.head[1] != 'G')
      continue;
    ...
    case 'R':
      color_ = auto_aim::Color::red;
      break;
    case 'B':
      color_ = auto_aim::Color::blue;
      break;
    default:
      color_ = std::nullopt;
      break;
...
std::optional<auto_aim::Color> Gimbal::color() const { return this->color_; }
